...
if (!process.env.SUPABASE_URL || !process.env.SUPABASE_SERVICE_KEY) {
  ...
  logHit = async (req) => {
    // create unique user signature without any personally identifiable information
    // send neither the IP address nor the raw user agent
    // see https://usefathom.com/data for inspiration
